function Export-MSDatabaseMail {
<#
.SYNOPSIS
...
.EXAMPLE
  Export-MSDatabaseMail -SqlInstance "MyServer" -Path "C:\temp\sql"

.EXAMPLE
  Export-MSDatabaseMail -SqlInstance "ProdListener,1433" -Filename "D:\exports\dbmail_Prod.sql"
...
#>
  ...
  process {
    try {
      Write-LogSafe -Level Info -Message "Starting Export-MSDatabaseMail for instance [$SqlInstance]"
...
"@
      ...
      Write-LogSafe -Level Info -Message "Finished Export-MSDatabaseMail for instance [$SqlInstance]"
    }
  }
}
