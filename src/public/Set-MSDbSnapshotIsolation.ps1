function Set-MSDbSnapshotIsolation {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        Set-MSDbSnapshotIsolation -SqlInstance "MyServer\Instance" -Database "MyDb" -Enable

    .EXAMPLE
        Set-MSDbSnapshotIsolation -SqlInstance "MyServer\Instance" -Database "MyDb"
    #>
