function Get-MSSecondaryServerName {
<#
.SYNOPSIS
...
.EXAMPLE
    Get-MSSecondaryServerName -SqlInstance SQL-ALIAS

.EXAMPLE
    Get-MSSecondaryServerName -SqlInstance SQL-ALIAS -AsArray

.EXAMPLE
    Get-MSSecondaryServerName -SqlInstance SQL-ALIAS -MainOnly
