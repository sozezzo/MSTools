function Repair-MSModule {
<#
.SYNOPSIS
    Forces a PowerShell module to reload by removing and re-importing it.

.DESCRIPTION
    Repair-MSModule removes an already loaded module from the current PowerShell session
